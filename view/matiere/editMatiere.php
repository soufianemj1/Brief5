...
<div id="inputs">
<form action="http://localhost/mvcBrief5/matiere/update" method="post">
  ...
  <input  type="text" class="form-control"aria-label="Username" aria-describedby="addon-wrapping" name="libelle" value="<?=$obj['libelle_matiere']?>" >
</div>
